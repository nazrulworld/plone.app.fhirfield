...
try:
    ...
    # Need Patch something
    from collective.fhirpath.EsIndexes import EsFhirFieldIndex as EFI

    setattr(EFI, "_old_get_query", EFI.get_query)
    setattr(EFI, "get_query", EsFhirFieldIndex.get_query)
